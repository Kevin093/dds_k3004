...
<html>
    ...
    <script>
     ...
     if(adminCheck == true){
            window.location.replace("html/admin/validateAdmin.jsp?user="+userName+"&pass="+passUser+"&type="+'Administrador');
            
        }
       else
    {
      window.location.replace("html/terminal/validateTerminal.jsp?user="+userName+"&pass="+passUser+"&type="+'Terminal');
    }
}}
    </script>
